      ...
      <main className="mx-auto max-w-4xl px-6 pt-16 pb-24">
        ...
        <section className="mt-16">
          ...
          <div className="mt-4 space-y-2">
            ...
            <ContractRow label="TreasurySplitter (80/20 INS → DAO)" addr="0x6Da215700aca9F35714Dce20b0c09735d92282E2" />
          </div>
        ...
        <section className="mt-16">
          ...
          <ol className="mt-4 space-y-3 text-sm text-white/70">
            ...
            <Milestone done title="Emoji & Unicode names — LIVE" body="Type any emoji (🔥, 🚀, 💎) or ZWJ family (👨‍👩‍👧‍👦) or flag (🇺🇸) and it just works — dApp normalizes via ENSIP-15 (the same standard ENS uses, Unicode 17.0 + CLDR 47), Punycode-encodes for the chain, and beautifies it back for display. Confusable/homograph attacks blocked end-to-end (Cyrillic а look-alike, mixed-script, bidi controls, zero-width invisibles all rejected). Same shape across resolve / reverse / by-owner / recent in the REST API + NFT card renders via twemoji." />
            <Milestone done title="Igra DAO partnership — LIVE" body="TreasurySplitter deployed on Igra L2 mainnet at 0x6Da215700aca9F35714Dce20b0c09735d92282E2 — every future Registry / Marketplace withdrawal automatically routes 20% to the Igra DAO multisig (0x9087…A2c2) and 80% to the INS Treasury Safe. Permissionless flush(), Safe-owned admin via Ownable2Step. 41 tests + 4 fuzz × 256 runs all green. Spec at docs/TREASURY_SPLITTER.md." />

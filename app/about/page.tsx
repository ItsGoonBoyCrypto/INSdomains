      ...
      <main className="mx-auto max-w-4xl px-6 pt-16 pb-24">
        ...
        <section className="mt-16">
          ...
          <ol className="mt-4 space-y-3 text-sm text-white/70">
            ...
            <Milestone done title="Emoji & Unicode names — live" body="V2's label validator accepts full Unicode via Punycode (xn--ls8h.igra renders as 🦄.igra in wallets) — same standard ENS uses. Mint via the dApp; the frontend handles encoding. Single-emoji + double-emoji slots are reserved on chain for fair launch." />

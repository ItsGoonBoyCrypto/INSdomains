...
// Rabby brand palette, sampled directly from rabby.io/static/css/main.*.css
const RABBY_BLUE = "#4c65ff";
const RABBY_BLUE_SOFT = "#7084ff";
const RABBY_NAVY = "#192945";

/**
 * GET /api/rabby-launch-image?size=hd|qhd|4k
 *
 * Prep card for the Rabby launch tweet — fires the moment RabbyHub/Rabby
 * PR #3826 merges. Same visual language as /api/snap-launch-image
 * (INK base, cyan/plum sparks, INS brand bar, mock wallet Send screen)
 * but swaps MetaMask fox-orange for the Rabby blue #4c65ff and their
 * navy #192945 sampled from their site.
 *
        ...
        {SPARKS.map(([x, y, sz, rot, op], i) => (
          <div
            ...
            style={{
              ...
              background: i % 3 === 0 ? CYAN : i % 3 === 1 ? RABBY_BLUE : PLUM,
              opacity: op,
              boxShadow: `0 0 ${s(18)}px ${i % 3 === 0 ? CYAN : i % 3 === 1 ? RABBY_BLUE : PLUM}`,
            }}
          />
        ))}
        ...
        <div style={{ display: "flex", flexDirection: "column", width: "100%", height: "100%", padding: `${s(54)}px ${s(80)}px` }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", marginTop: s(28) }}>
            ...
            <div
              style={{
                ...
                lineHeight: 1.0,
                marginTop: s(6),
                backgroundImage: `linear-gradient(110deg, ${RABBY_BLUE} 0%, ${RABBY_BLUE_SOFT} 50%, ${PLUM} 100%)`,
                backgroundClip: "text",
                color: "transparent",
              }}
            >
            ...
            <div style={{ display: "flex", fontSize: s(26), fontWeight: 600, color: "rgba(255,255,255,0.66)", marginTop: s(8), letterSpacing: s(1) }}>
              Type a name → resolves in Rabby. No copy-paste. No extension switching.
            </div>
          </div>
          ...
          <div
            style={{
              ...
              padding: s(22),
              borderRadius: s(22),
              background: `linear-gradient(180deg, ${RABBY_NAVY} 0%, #0e1729 100%)`,
              border: "1px solid rgba(255,255,255,0.10)",
              boxShadow: `0 ${s(30)}px ${s(60)}px rgba(0,0,0,0.5), 0 0 ${s(80)}px rgba(76,101,255,0.10)`,
              gap: s(14),
            }}
          >
            {/* mock window header */}
              ...
              <div style={{ display: "flex", alignItems: "center", gap: s(10) }}>
                <div
                  style={{
                    ...
                    height: s(34),
                    borderRadius: s(9),
                    background: `linear-gradient(135deg, ${RABBY_BLUE} 0%, ${RABBY_BLUE_SOFT} 100%)`,
                    color: "#fff",
                    fontSize: s(20),
                    fontWeight: 900,
                  }}
                ...
                <div style={{ display: "flex", fontSize: s(20), fontWeight: 700, color: "rgba(255,255,255,0.85)" }}>Rabby Wallet</div>
                <div style={{ display: "flex", padding: `${s(3)}px ${s(10)}px`, borderRadius: 999, background: "rgba(76,101,255,0.20)", border: `1px solid ${RABBY_BLUE}66`, fontSize: s(13), fontWeight: 700, color: RABBY_BLUE_SOFT, marginLeft: s(8) }}>Ethereum Mainnet</div>
              </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: s(8) }}>
              ...
              <div style={{
                ...
                border: `2px solid ${RABBY_BLUE}88`,
                boxShadow: `0 0 ${s(30)}px rgba(76,101,255,0.20) inset`,
                fontSize: s(36),
                fontFamily: "monospace",
                color: "#fff",
                fontWeight: 700,
              }}>
                <span style={{ display: "flex", color: RABBY_BLUE_SOFT }}>|</span>
            ...
            {/* resolution result — Rabby-styled */}
            <div style={{
              display: "flex",
              flexDirection: "column",
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "center", marginTop: s(18), gap: s(18) }}>
            ...
            <div style={{
              ...
              borderRadius: s(12),
              background: `${RABBY_BLUE}22`,
              border: `1px solid ${RABBY_BLUE}66`,
              fontSize: s(26),
              fontWeight: 900,
              color: RABBY_BLUE_SOFT,
              letterSpacing: s(1),
              boxShadow: `0 0 ${s(30)}px rgba(76,101,255,0.20)`,
            }}>
              @Rabby_io
            </div>
          </div>

...
// NOTE: pricing intentionally lives on /about + the OG card, not on the
// promo image. The promo image is the visual brand pitch — high-level
// value props for outreach + as the homepage hero. Keeping it pricing-
// free means it never goes stale when tiers are tuned.
